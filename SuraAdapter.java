...
public SuraAdapter(Context context, List<String> surahList, List<String> translatedSuraList ) { 
...
holder.txtSuraNum = (TextView) convertView.findViewById(R.id.itemDate);
holder.txtSuraName = (TextView) convertView.findViewById(R.id.itemTitle);
holder.txtTranslatedSuraName = (TextView) convertView.findViewById(R.id.itemDate);
