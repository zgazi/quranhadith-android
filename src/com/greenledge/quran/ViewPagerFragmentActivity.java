...
public class ViewPagerFragmentActivity extends FragmentActivity implements OnTabChangeListener, OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.setup();
		String[] tabs = {"Prayer","Quran","Hadith","Books","Audios","Videos","News","Events"};
		...
		{
			tabUrls[i] = (lang == "") ? baseUrl+tabs[i]+".xml" : baseUrl+tabs[i]+"-"+lang+".xml";
...
*/
			...
			case R.id.menu_about:
		        ...
		        intent.putExtra("link", baseUrl+"credits.html");
		        ...
		        intent.putExtra("image", "http://greenledge.com/greenledge/images/greenledge.jpg");
