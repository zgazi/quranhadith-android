...
public class HomeActivity extends TabActivity implements OnTabChangeListener, OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    db 	= new DatabaseHandler("quran.db");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_preferences:
			...
			break;
			/*		case R.id.search: 
			Intent searchIntent = new Intent(this, SearchQuran.class);
...
/*		  case R.id.surahList:
			  Intent intent = new Intent(this, DisplaySurah.class);
		  ...
		  case R.id.bookmarkList:
			  Intent bookmarkIntent = new Intent(this, DisplaySurah.class);
