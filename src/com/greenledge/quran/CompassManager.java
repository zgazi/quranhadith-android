...
public class CompassManager implements SensorEventListener, LocationListener {
    ...
    public CompassManager(Context ctx) {
        this.context = ctx;
    }
    ...
    private double changeQiblaDirection(double value) {
        ...
        directionChangedLock.writeLock().lock();
        try {
            ...
            directionChangedLock.writeLock().unlock();
        }
        return returnValue;
    }
    ...
    public Map<String, Double> fetchDeltaAngles() {
        ...
        directionChangedLock.readLock().lock();
        try {
            if (isNorthChanged)
            ...
            directionChangedLock.readLock().unlock();
        }
        return returnValue;
    }
...
class LocationChangedAsyncTask extends AsyncTask<Location, Void, Double> {
    ...
    protected Double doInBackground(Location... params) {
        ...
        double northDirection = CompassManager
    ...
    protected void onPostExecute(Double result) {
        // TODO Auto-generated method stub
        Message message = mHandler.obtainMessage();
        message.what = CompassManager.MESSAGE_ON_QIBLA_DIRECTION;
        Bundle bundle = new Bundle();
        bundle.putDouble(CompassManager.MESSAGE_DEVICE_LOCATION_KEY,
                result.doubleValue());
        message.setData(bundle);
